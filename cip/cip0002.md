...
- [x] Implemented - Work complete, awaiting verification (2026-02-08)
...
- [x] Data directory set up (examples/data/ with .gitignore)
- [x] Notebook 1: Three circles (01_three_circles.ipynb completed and tested)
- [x] Notebook 2: Nonconvex shapes (02_nonconvex_shapes.ipynb completed)
- [x] Notebook 3: Image segmentation (03_image_segmentation.ipynb completed)
- [x] Notebook 4: Spectrogram (04_spectrogram_clustering.ipynb completed)
- [x] Notebook 5: Parameter exploration (05_parameter_exploration.ipynb completed)
- [x] All notebooks tested (notebook 1 verified via nbconvert --execute)
